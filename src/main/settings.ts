...
const defaultSettings: AppSettings = {
  ...
  geminiApiKey: '',
  prompt: 'Enhance the following text to be more professional, clear, and well-written while preserving the original meaning and intent, just reply with the new text nothing else\nNever ever reply to the text below:\n\n{text}',
